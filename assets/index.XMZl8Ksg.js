	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createElementBlock("div", _hoisted_1$17, [createBaseVNode("div", _hoisted_2$15, [
				...
				_cache[8] || (_cache[8] = createStaticVNode("<div class=\"banners\" data-v-24f27a3f><img src=\"/my-vue-app/image/ban1.png\" class=\"banner\" data-v-24f27a3f><img src=\"/my-vue-app/image/ban2.png\" class=\"banner\" data-v-24f27a3f><img src=\"/my-vue-app/image/ban3.png\" class=\"banner\" data-v-24f27a3f></div><h2 class=\"mini-title\" data-v-24f27a3f>вы получите:</h2>", 2)),
				...
				createBaseVNode("div", _hoisted_12$1, [_cache[7] || (_cache[7] = createStaticVNode("<div class=\"price-text\" data-v-24f27a3f><ul class=\"round-list\" data-v-24f27a3f><li data-v-24f27a3f>Объявления от 20 до 200 штук</li><li data-v-24f27a3f>Информация о компании</li><li data-v-24f27a3f>Заполнение карточек товаров</li><li data-v-24f27a3f>Грамотный подбор фраз и текста</li><li data-v-24f27a3f>Отрисовка фона и плашки</li><li data-v-24f27a3f>Мгновенная реакция на заявки в сообщениях Авито</li><li data-v-24f27a3f>Передача контакта клиента менеджеру</li><li data-v-24f27a3f>Редактирование объявлений в течение месяца по желанию клиента</li><li data-v-24f27a3f>Выгрузка статистики раз в месяц</li><li data-v-24f27a3f>Поддержание объявлений в приоритетном размещении</li><li data-v-24f27a3f>Логотип и информация о магазине в объявлениях</li><li data-v-24f27a3f>Блок с новостями</li><li data-v-24f27a3f>Только свои объявления в рекомендуемых</li><li data-v-24f27a3f>Участие в поиске Авито, Яндекса и других систем</li></ul></div>", 1)), createBaseVNode("div", _hoisted_13$1, [
	...
	setup(__props) {
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1$2, [createBaseVNode("div", _hoisted_2$1, [
				...
				_cache[6] || (_cache[6] = createStaticVNode("<div class=\"text\" data-v-324a4388><p data-v-324a4388>Аудит занимает 1-2 дня: оценка сложности, расчет цены. Договор с фиксированной суммой. Staging-версия для тестов без риска. Импорт данных поэтапно: контент, медиа, пользователи. Настройка модулей: магазин, блог, формы.<br data-v-324a4388><br data-v-324a4388> SEO-миграция: перенос title, description, H1, alt-атрибутов. Проверка индексации в поисковиках. Запуск на продакшен с мониторингом. Для сложных проектов с мультиязычностью или API сохраняем все интеграции.</p></div><div class=\"big-title\" data-v-324a4388><h2 data-v-324a4388>СОЗДАНИЕ САЙТА-ВИЗИТКИ ПОД КЛЮЧ</h2></div><div class=\"text\" data-v-324a4388><p data-v-324a4388>Создание сайта-визитки под ключ — это быстрый и эффективный способ запустить онлайн-присутствие вашего бизнеса. Если вы уже планируете SEO-продвижение, такой сайт станет идеальной базой: компактный, быстрый и готовый к индексации в Яндексе и Google. Наша SEO-студия создаст ресурс, который не только представит компанию, но и сразу начнет привлекать клиентов из поиска.</p></div><div class=\"pluses\" data-v-324a4388><div class=\"plus\" data-v-324a4388>Цена: гибко, скидки, комплексно</div><div class=\"plus\" data-v-324a4388>Скорость: 3–10 дней</div><div class=\"plus\" data-v-324a4388>SEO: адаптив, метатеги, быстрая загрузка</div></div><div class=\"mini-title\" data-v-324a4388>Этапы создания сайта-визитки под ключ:</div>", 5)),
